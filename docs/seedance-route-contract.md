...
- Its channel base URL omits `/v1`; the forward rule supplies `/v1/videos` and `/v1/videos/${task_id}`.
...
As of 2026-09-11, authenticated RavenHash model discovery exposes both public model IDs. Parameter tests cover the fixed contract. No paid generation has been used to verify the new route end to end.
