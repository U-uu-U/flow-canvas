// 本文件由 scripts/sync-model-config.mjs --write 从 shared/model-config.default.json 生成。
...
export const DEFAULT_MODEL_CONFIG = {
    ...
    "fields": {
        ...
        "responseFormat": {
            ...
            "type": "enum",
            "nodeKey": "responseFormat"
        },
        "historyDisabled": {
            "label": "关闭历史记录",
            "param": "history_disabled",
            "type": "boolean",
            "nodeKey": "historyDisabled"
        },
        "stream": {
            "label": "流式返回",
            "param": "stream",
    ...
    "models": [
        {
            "id": "ravenhash-image.gpt-image-2",
            "label": "gpt-image-2",
            "kind": "image",
            "channel": "RavenHash图片",
            "route": "图片线路",
            ...
            "capabilities": {
                "referenceImages": {
                    "supported": true,
                    "maxBytesPerImage": 52428800,
                    "note": "参考图单张最大 50MB；有参考图时走 /images/edits"
                },
                "negativePrompt": {
                    "supported": true
                },
            ...
            "notes": "单次1-8张；参考图单张最大50MB；quality为auto/low/medium/high；支持1K/2K/4K及常用比例；有参考图时走/images/edits"
        },
        {
            "id": "ravenhash-image.gpt-image-2.5-sunburst",
            ...
            "options": {
                "resolutionTier": {
                    ...
                    "default": "4K",
                    "encode": "dimensions",
                    "note": "已实测 3840x2160；复用通用图片请求"
                },
                "n": {
                    "type": "unknown",
                    "reason": "复用通用图片请求，未单独维护单次张数上限"
                }
            },
            "capabilities": {
                "referenceImages": {
                    "supported": true,
                    "note": "已实测使用 2 张参考图；数量上限未单独维护"
                }
            },
            "prompt": {
                "required": true
        ...
        },
        {
            ...
            "options": {
                ...
                "quality": {
                    "type": "unknown",
                    "reason": "MJ 线路不使用 OpenAI 兼容的 quality 字段；--q 只接受 0.5/1/2/4（界面用 midjourneyQuality=default 表示不发送该参数）"
                },
                "imageWeight": {
                    "type": "range",
                    "min": 0,
            ...
            "capabilities": {
                "referenceImages": {
                    "supported": true,
                    "note": "参考图必须是公网可访问的 HTTP(S) 地址，本地图会先上传"
                },
                "negativePrompt": {
                    "supported": true
                }
            ...
            "limits": {
                "concurrency": 1,
                "resultsPerRequest": 4,
                "resultsPerRequestNote": "每次返回四宫格",
                "note": "单节点请求并发固定 1"
            },
            "notes": "每次返回四宫格；单节点请求并发固定1；Stylize 0-1000；Chaos 0-100；Weird 0-3000；Seed 0-4294967295；Repeat 1-4"
        },
        {
            ...
            "limits": {
                "concurrency": 1,
                "passRate": 0.9,
                "passRateNote": "通过率约 90%"
            },
            "notes": "固定30秒、720p；最多9张参考图；支持人脸，通过率约90%；比例支持adaptive/16:9/9:16/1:1/4:3/3:4"
        },
        {
        ...
        },
        {
            ...
            "notes": "采用933满血版入参；没有内容审核限制；支持人脸和NSFW；技术参数范围仍以上游接口实际返回为准"
        },
        {
            ...
            "notes": "提示词必填且最多5000字；4-15秒；480p/768p/1080p/2K/4K；最多9图、3视频、3音频；adaptive按首张图匹配比例"
        },
        {
            ...
            "notes": "4-15秒；480p/768p/1080p/2K/4K；最多9图、3视频、3音频；自动选择文生视频、首尾帧或多参考工作流"
        },
        {
            ...
            "match": {
                ...
                "endpoint": "kyyReactApiServer|model-center/tasks"
            },
            "parameters": {
                "accepts": [
                    "model",
        ...
        },
        {
            ...
            "options": {
                "tools": {
                    "type": "unknown",
                    "reason": "线路兼容 tools，未维护模型专属工具能力表"
                },
                "stream": {
                    "type": "unknown",
                    "reason": "线路兼容 stream"
            ...
            "limits": {
                "contextWindow": {
                    "type": "unknown",
                    "reason": "当前没有维护模型专属上下文窗口和最大输出 Token 限制表"
                }
            },
            "notes": "当前没有维护模型专属上下文窗口和最大输出Token限制表"
        },
        {
            "id": "text.anthropic.claude-opus-5",
            "label": "claude-opus-5",
            "kind": "text",
            "channel": "文字模型",
            "route": "Anthropic线路",
