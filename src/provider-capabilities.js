...
export function inferProviderCapability(provider = {}) {
    ...
    if (/(seedance|^sd2[._-]?5(?:-route[12]|-haidiyue-face)?(?:\s|$)|artsdance|dreamina|video|kling|可灵|sora|runway|veo|vidu|minimax[^a-z0-9]*h3|hunyuan|腾讯|通义.*视频|wan[^\s]*(?:t2v|i2v))/.test(marker)) {
